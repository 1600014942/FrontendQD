...
| 官网 | `https://eu.jerrypsy.top/acu/index/` | 品牌入口与首页 |
| 控制台 | `https://eu.jerrypsy.top/acu/dashboard/overview` | 主导航“控制台” |
| API / 价格 | `https://eu.jerrypsy.top/acu/pricing` | 页脚与 ACU 指数页 CTA |
